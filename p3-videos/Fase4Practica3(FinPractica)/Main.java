...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		while(true) {//Bucle infinito
			...
			//Ultimas modificaciones de la practica y comprobaciones finales
			//¿Qué ocurre si la petición es nula ?
			//Un aspecto a comprobar es si la peticion es != null no es nula
			//debemos monitorear tal y como se indica este aspecto
			
			if(peticionRecibida == null) {
				///No hace nada
			}else {
		...
		//**********************Codigo para las pruebas en CMD*******/
